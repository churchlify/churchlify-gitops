...
training_controls = {
    ...
    "TRAINING_PRETRAINED_WEIGHTS_APPROVED": "false",
    ...
    "TRAINING_AUGMENT_SCALE_MIN": "0.60",
    "TRAINING_AUGMENT_SCALE_MAX": "1.00",
    "TRAINING_AUGMENT_HORIZONTAL_FLIP": "0.50",
    "TRAINING_AUGMENT_BRIGHTNESS": "0.15",
    ...
    "TRAINING_TINY_POSITIVE_REPLAY_FACTOR": "4",
    "TRAINING_RETAIN_DIAGNOSTIC_CHECKPOINTS": "true",
    "TRAINING_MAX_DIAGNOSTIC_CHECKPOINTS": "5",
    ...
    "TRAINABILITY_IMAGE_COUNT": "40",
    "TRAINABILITY_STEPS": "600",
    "TRAINABILITY_BATCH_SIZE": "2",
